...
class AgentSacTrainer(object):
    ...
    def __init__(self, cfg, global_count):
        ...
        self.train_dset = SpgDset(self.cfg.data_dir, dict_to_attrdict(self.cfg.patch_manager), max(self.cfg.s_subgraph))
        self.val_dset = SpgDset(self.cfg.val_data_dir, dict_to_attrdict(self.cfg.patch_manager), max(self.cfg.s_subgraph))
